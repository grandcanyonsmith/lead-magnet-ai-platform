 ...
 * Run with: node test-usage-report.js
 */
...
// Import the compiled service from backend/api
const path = require('path');
const { usageTrackingService } = require(path.join(__dirname, 'backend/api/dist/services/usageTrackingService'));
