 ...
 */
export type RequestHandler = (params: Record<string, string>, body: any, query: Record<string, string | undefined>, tenantId?: string, context?: RequestContext) => Promise<RouteResponse>;
/**
