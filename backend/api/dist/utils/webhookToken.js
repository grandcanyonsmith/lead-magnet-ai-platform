...
exports.isValidWebhookToken = isValidWebhookToken;
 ...
 * ```
 */
function generateWebhookToken(length = TOKEN_BYTE_LENGTH) {
    if (typeof length !== 'number' || length < 16 || length > 128) {
        throw new errors_1.ValidationError('Token length must be between 16 and 128 bytes');
    }
