...
exports.formAIController = exports.FormAIController = void 0;
...
Return ONLY the CSS code, no markdown formatting, no explanations.`;
            ...
            if (cleanedCss.startsWith('```css')) {
                ...
                logger_1.logger.info('[Form CSS Generation] Removed ```css markers');
            }
            else if (cleanedCss.startsWith('```')) {
                cleanedCss = cleanedCss.replace(/^```\s*/i, '').replace(/\s*```$/i, '');
                logger_1.logger.info('[Form CSS Generation] Removed ``` markers');
            }
...
Return ONLY the modified CSS code, no markdown formatting, no explanations.`;
            ...
            if (cleanedCss.startsWith('```css')) {
                cleanedCss = cleanedCss.replace(/^```css\s*/i, '').replace(/\s*```$/i, '');
                logger_1.logger.info('[Form CSS Refinement] Removed ```css markers');
            }
            else if (cleanedCss.startsWith('```')) {
                cleanedCss = cleanedCss.replace(/^```\s*/i, '').replace(/\s*```$/i, '');
                logger_1.logger.info('[Form CSS Refinement] Removed ``` markers');
            }
...
exports.FormAIController = FormAIController;
exports.formAIController = new FormAIController();
//# sourceMappingURL=formAIController.js.map