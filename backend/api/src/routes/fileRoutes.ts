...
export function registerFileRoutes(): void {
  ...
  router.register(
    ...
    async (params, body, query, tenantId, context) => {
      ...
      return await filesController.upload(
        params,
        body,
        query,
        tenantId,
  ...
  router.register(
    ...
    "/files/:fileId",
    async (params, body, query, tenantId, context) => {
      logger.info("[File Routes] GET /files/:fileId", {
  ...
  router.register(
    ...
    "/files/:fileId",
    async (params, body, query, tenantId, context) => {
      logger.info("[File Routes] DELETE /files/:fileId", {
        fileId: params.fileId,
      });
      return await filesController.delete(
        params,
        body,
        query,
        tenantId,
  ...
  router.register(
    ...
    async (params, body, query, tenantId, context) => {
      ...
      return await filesController.search(
        params,
        body,
        query,
        tenantId,
