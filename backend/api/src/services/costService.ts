...
const OPENAI_PRICING: Record<string, { input_per_1k_tokens_usd: number; output_per_1k_tokens_usd: number }> = {
  'gpt-4o': {
 ...
 */
export function getModelPricing(model: string): { input_per_1k_tokens_usd: number; output_per_1k_tokens_usd: number } {
