...
function createMockEvent(path, method, body, queryParams) {
  return {
    version: '2.0',
...
// Test function
async function testEndpoint(name, path, method, body, queryParams) {
  console.log(`\n${'='.repeat(60)}`);
...
async function runTests() {
  ...
  await testEndpoint(
    ...
    'POST',
    { description: 'rich snippet generator', model: 'gpt-5' }
  );
...
module.exports = { testEndpoint, createMockEvent, mockContext };
