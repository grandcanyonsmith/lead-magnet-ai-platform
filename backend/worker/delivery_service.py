...
from services.webhook_helper import WebhookPayloadBuilder
...
class DeliveryService:
    ...
    def send_webhook_notification(
        ...
        builder = WebhookPayloadBuilder(self.s3_service)
        payload = builder.build_payload(job_id, output_url, submission, job, all_artifacts)
