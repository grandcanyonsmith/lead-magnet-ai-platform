#!/usr/bin/env python3
"""
Script to remove Stripe checkout logic and replace with direct payment link redirects.
"""
...
def fix_template(html_content):
    ...
    # To: const redirectLink = document.createElement("a"); redirectLink.href = "..."
    html_content = re.sub(
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python3 fix-template-stripe.py <input_file> [output_file]")
        sys.exit(1)
