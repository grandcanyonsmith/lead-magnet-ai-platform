...
export const workflowContracts = {
  list: {
    ...
    __types: defineTypes<WorkflowListQuery | undefined, void, WorkflowListResponse>(),
  },
  detail: {
    method: 'GET',
  ...
  generateWithAI: {
    ...
    docs: 'docs/contracts/README.md#workflows',
    __types: defineTypes<void, WorkflowGenerationRequest, WorkflowGenerationResponse>(),
  },
  generationStatus: {
    method: 'GET',
  ...
  refineInstructions: {
    ...
    docs: 'docs/contracts/README.md#workflows',
    __types: defineTypes<void, WorkflowRefineInstructionsRequest, WorkflowRefineInstructionsResponse>(),
  },
  aiStep: {
    method: 'POST',
...
export const formContracts = {
  list: {
    ...
    __types: defineTypes<Record<string, unknown> | undefined, void, FormListResponse>(),
  },
  detail: {
    method: 'GET',
    path: '/admin/forms/:id',
  ...
  generateCss: {
    ...
    docs: 'docs/contracts/README.md#forms',
    __types: defineTypes<void, FormGenerateCSSRequest, FormGenerateCSSResponse>(),
  },
  refineCss: {
    method: 'POST',
...
export const templateContracts = {
  list: {
    ...
    __types: defineTypes<Record<string, unknown> | undefined, void, TemplateListResponse>(),
  },
  detail: {
    method: 'GET',
  ...
  generateWithAI: {
    ...
    docs: 'docs/contracts/README.md#templates--notifications-snapshot',
    __types: defineTypes<void, TemplateGenerateRequest, TemplateGenerateResponse>(),
  },
  refineWithAI: {
    method: 'POST',
...
export const notificationContracts = {
  list: {
    ...
    docs: 'docs/contracts/README.md#templates--notifications-snapshot',
    __types: defineTypes<{ unread_only?: boolean } | undefined, void, NotificationListResponse>(),
  },
  markRead: {
    method: 'POST',
...
export const settingsContracts = {
  ...
  analytics: {
    ...
    docs: 'docs/contracts/README.md#settings--analytics-snapshot',
    __types: defineTypes<Record<string, unknown> | undefined, void, AnalyticsResponse>(),
  },
  usage: {
    method: 'GET',
    path: '/admin/usage',
    ...
    docs: 'docs/contracts/README.md#settings--analytics-snapshot',
    __types: defineTypes<{ start_date?: string; end_date?: string } | undefined, void, UsageResponse>(),
  },
} satisfies Record<string, ApiEndpointContract<any, any, any>>
