...
class ApiClientImpl extends BaseApiClient implements ApiClient {
  ...
  async generateWorkflowWithAI(
    request: Parameters<WorkflowsClient["generateWorkflowWithAI"]>[0],
  ) {
  ...
  async refineWorkflowInstructions(
    workflowId: string,
    request: Parameters<WorkflowsClient["refineWorkflowInstructions"]>[1],
  ) {
    return this.workflows.refineWorkflowInstructions(workflowId, request);
  }

  async refineInstructions(
    request: Parameters<WorkflowsClient["refineInstructions"]>[0],
  ) {
  ...
  async generateStepWithAI(
    workflowId: string,
    request: Parameters<WorkflowsClient["generateStepWithAI"]>[1],
  ) {
  ...
  async streamWorkflowEdit(
    workflowId: string,
    request: Parameters<WorkflowsClient["streamWorkflowEdit"]>[1],
    callbacks: Parameters<WorkflowsClient["streamWorkflowEdit"]>[2],
    signal?: Parameters<WorkflowsClient["streamWorkflowEdit"]>[3],
  ) {
    return this.workflows.streamWorkflowEdit(
      workflowId,
      request,
      callbacks,
      signal,
  ...
  async getWorkflowAIEditStatus(jobId: string) {
  ...
  async updateFolder(
    id: string,
    data: Parameters<WorkflowsClient["updateFolder"]>[1],
  ) {
  ...
  async generateFormCSS(
    request: Parameters<FormsClient["generateFormCSS"]>[0],
  ) {
