...
export class FormsClient extends BaseApiClient {
  ...
  async generateFormCSS(request: FormGenerateCSSRequest): Promise<FormGenerateCSSResponse> {
  ...
  async refineFormCSS(request: FormRefineCSSRequest): Promise<FormRefineCSSResponse> {
