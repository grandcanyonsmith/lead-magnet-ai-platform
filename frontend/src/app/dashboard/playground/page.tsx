...
export default function PlaygroundPage() {
  ...
  const activeStepNumber =
    typeof activeStepIndex === "number" ? activeStepIndex + 1 : null;
  const selectedStepNumber =
    typeof selectedStepIndex === "number" ? selectedStepIndex + 1 : null;
  const selectedStep =
    typeof selectedStepIndex === "number" ? steps[selectedStepIndex] : null;
