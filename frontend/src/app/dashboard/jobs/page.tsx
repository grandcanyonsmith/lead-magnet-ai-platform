          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="relative inline-block w-full md:w-64">
              <Select
                ...
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-card text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 transition-all cursor-pointer shadow-sm"
              >
