...
export default function NewFormPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    public_slug: '',
    form_fields_schema: {
      fields: [...REQUIRED_FIELDS] as FormField[]
    },
    ...
    <div>
      ...
      <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>How it works:</strong> When leads submit this form, your AI lead magnet will be automatically generated and sent to them via your configured delivery method (webhook or SMS).
        </p>
      </div>
