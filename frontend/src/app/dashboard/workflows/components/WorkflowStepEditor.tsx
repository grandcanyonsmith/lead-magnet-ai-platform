...
import {
  ...
  FiChevronDown,
  FiZap,
  FiChevronDown as FiChevronCollapse,
  FiChevronUp as FiChevronExpand,
} from "react-icons/fi";
...
export default function WorkflowStepEditor({
  ...
  const handleToolToggle = (toolValue: string) => {
    ...
    if (isSelected) {
      ...
      if (toolValue === "computer_use_preview") {
        ...
        const currentConfig: typeof imageGenerationConfig =
  ...
  const handleImageGenerationConfigChange = (
    field: keyof typeof imageGenerationConfig,
    value: any,
  ) => {
            ...
            {showAIAssist && (
              <div className="mt-3 p-4 border border-purple-200 rounded-lg bg-white">
                <p className="text-sm text-gray-600 mb-3">
                  Describe how you want to change this step, and AI will
                  generate an updated configuration for you to review.
                </p>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                const newStepType = e.target.value as
                  | "ai_generation"
                  | "webhook";
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
                      <div>
                        ...
                        <input
                          ...
                          aria-invalid={
                            computerUseConfig.display_width < 100 ||
                            computerUseConfig.display_width > 4096
                          }
                        />
                        {(computerUseConfig.display_width < 100 ||
                          computerUseConfig.display_width > 4096) && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          aria-invalid={
                            computerUseConfig.display_height < 100 ||
                            computerUseConfig.display_height > 4096
                          }
                        />
                        {(computerUseConfig.display_height < 100 ||
                          computerUseConfig.display_height > 4096) && (
                ...
                {isToolSelected("image_generation") && (
                  <div className="mt-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      {(imageGenerationConfig.format === "jpeg" ||
                        imageGenerationConfig.format === "webp") && (
                        <div>
                          <label className="block text-xs font-medium text-gray-600 mb-1">
                            Compression (
                            {imageGenerationConfig.compression ?? 85}%)
                          </label>
                          <input
                            type="range"
                            min="0"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("webhook_content_type", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
