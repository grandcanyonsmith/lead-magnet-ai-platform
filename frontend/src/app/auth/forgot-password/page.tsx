...
export default function ForgotPasswordPage() {
  ...
  const handleConfirm = async (e: React.FormEvent) => {
    ...
    try {
      const result = await confirmForgotPassword(trimmedEmail, trimmedCode, trimmedPassword)
      if (result.success) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          {error && (
            <div className="bg-red-50 border-l-4 border-red-400 text-red-700 px-4 py-3 rounded-md mb-4 flex items-start" role="alert" aria-live="polite">
          ...
          {message && (
            <div className="bg-green-50 border-l-4 border-green-500 text-green-800 px-4 py-3 rounded-md mb-4" role="status" aria-live="polite">
          ...
          <div className="text-center pt-4 border-t border-gray-200 mt-6">
            <Link href="/auth/login" className="text-sm font-medium text-primary-600 hover:text-primary-700 transition-colors">
              Back to sign in
            </Link>
          </div>
        </div>
