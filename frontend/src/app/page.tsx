...
export default function Home() {
  ...
  const checkAuthAndRedirect = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Auth check failed on home page', { error: err, context: 'Home' })
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md p-6" role="alert">
          ...
          <p className="text-red-600 mb-4" aria-live="polite">{error}</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        {mounted && (
          <p className="text-sm text-gray-400 mt-2" aria-label="Checking authentication status">
