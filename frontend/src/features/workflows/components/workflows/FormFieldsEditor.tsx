...
import { FormFieldsData } from '@/features/workflows/hooks/useWorkflowForm'
...
export function FormFieldsEditor({ formFieldsData, onChange, onFieldChange }: FormFieldsEditorProps) {
    ...
    <div className="space-y-6 pt-6 border-t">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => onChange('public_slug', e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, ''))}
              ...
              {field.field_type === 'select' && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onFieldChange(index, 'options', e.target.value.split(',').map((o: string) => o.trim()).filter(Boolean))}
                    className="w-full px-2 py-1 border border-gray-300 rounded text-sm"
