          ...
          <div>
            <label className="flex items-center mb-2">
              <input
                ...
                onChange={(e) => onChange('delivery_sms_ai_generated', e.target.checked)}
                className="mr-2"
              />
          ...
          {formData.delivery_sms_ai_generated ? (
            <div>
              ...
              <textarea
                ...
                onChange={(e) => onChange('delivery_sms_ai_instructions', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => onChange('delivery_sms_message', e.target.value)}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
