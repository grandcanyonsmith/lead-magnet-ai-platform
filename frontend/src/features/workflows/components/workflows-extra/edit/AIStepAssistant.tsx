...
import { FiZap, FiChevronUp as FiChevronExpand, FiChevronDown as FiChevronCollapse } from 'react-icons/fi'
import { useWorkflowStepAI } from '@/features/workflows/hooks/useWorkflowStepAI'
import StepDiffPreview from '../../workflows/edit/StepDiffPreview'
...
export function AIStepAssistant({ workflowId, step, stepIndex, onAccept }: AIStepAssistantProps) {
  ...
  const handleAIGenerate = async () => {
    ...
    try {
      await generateStep(aiPrompt, step, stepIndex, 'update')
    } catch (err: any) {
