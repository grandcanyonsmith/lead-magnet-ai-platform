...
export type OpenJobDocumentResult = 'opened' | 'popup_blocked' | 'fallback_opened' | 'error'
...
function getUserFacingErrorMessage(error: unknown): string {
  ...
  if (raw.includes('403') || message.includes('forbidden') || message.includes('permission')) {
