...
export const NotificationBell: React.FC<NotificationBellProps> = ({
  ...
  return (
    <Popover className="relative">
      ...
      >
        <PopoverPanel
          className={`absolute right-0 mt-2 sm:w-80 md:w-96 bg-white rounded-xl shadow-2xl border border-gray-200 ${layer === "account_menu" ? "z-[60]" : "z-[101]"} max-h-[70vh] sm:max-h-[min(500px,calc(100vh-8rem))] overflow-hidden flex flex-col focus:outline-none origin-top-right`}
        >
          {({ close }) => (
            <>
