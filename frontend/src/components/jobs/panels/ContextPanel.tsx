...
export function ContextPanel({
  ...
  return (
    <CollapsiblePanel
      title={<span className="text-[11px] font-semibold uppercase tracking-wide text-teal-700 dark:text-teal-200">Context & Dependencies</span>}
      expanded={true}
      onToggle={() => onToggle && onToggle()}
      className="border-teal-200/70 bg-teal-50/40 ring-1 ring-teal-100/60 dark:border-teal-800/50 dark:bg-teal-950/25 dark:ring-teal-900/40"
