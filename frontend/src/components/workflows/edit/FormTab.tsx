...
import { FiSave, FiEye, FiMinimize2, FiMaximize2, FiPlus, FiMinus, FiMove } from 'react-icons/fi'
    ...
    <div className="space-y-6">
      ...
      <div className={`grid gap-6 ${showFormPreview ? 'lg:grid-cols-2' : 'grid-cols-1'}`}>
        ...
        <form onSubmit={onSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <CollapsibleSection
            title="Form Fields"
            isCollapsed={collapsedSections.fields}
          ...
          <CollapsibleSection
            title="Customization"
            isCollapsed={collapsedSections.customization}
            onToggle={() => onToggleSection('customization')}
          >
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
