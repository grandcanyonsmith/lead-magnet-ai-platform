...
import { useQuery as useReactQuery, UseQueryOptions as ReactUseQueryOptions, UseQueryResult } from '@tanstack/react-query'

export interface UseQueryOptions<TData, TError = Error> extends Omit<ReactUseQueryOptions<TData, TError>, 'queryKey' | 'queryFn'> {
  enabled?: boolean
